...
DoEvents
   ...
   'Plaques
    ...
    Elevator(5).SetPosition Elevator(5).GetPosition.X, GetFloorAltitude(80), Elevator(5).GetPosition.z
    Elevator(6).SetPosition Elevator(6).GetPosition.X, GetFloorAltitude(80), Elevator(6).GetPosition.z
    Elevator(7).SetPosition Elevator(7).GetPosition.X, GetFloorAltitude(80), Elevator(7).GetPosition.z
    Elevator(8).SetPosition Elevator(8).GetPosition.X, GetFloorAltitude(80), Elevator(8).GetPosition.z
    Elevator(9).SetPosition Elevator(9).GetPosition.X, GetFloorAltitude(80), Elevator(9).GetPosition.z
    Elevator(10).SetPosition Elevator(10).GetPosition.X, GetFloorAltitude(80), Elevator(10).GetPosition.z
    Elevator(15).SetPosition Elevator(5).GetPosition.X, GetFloorAltitude(80), Elevator(5).GetPosition.z
    Elevator(16).SetPosition Elevator(6).GetPosition.X, GetFloorAltitude(80), Elevator(6).GetPosition.z
    Elevator(17).SetPosition Elevator(7).GetPosition.X, GetFloorAltitude(80), Elevator(7).GetPosition.z
    Elevator(18).SetPosition Elevator(8).GetPosition.X, GetFloorAltitude(80), Elevator(8).GetPosition.z
    Elevator(19).SetPosition Elevator(9).GetPosition.X, GetFloorAltitude(80), Elevator(9).GetPosition.z
    Elevator(20).SetPosition Elevator(10).GetPosition.X, GetFloorAltitude(80), Elevator(10).GetPosition.z
