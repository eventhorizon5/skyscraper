...
CameraControl::CameraControl(DebugPanel* parent,wxWindowID id)
{
	...
	FlexGridSizer2->Add(txtDirectionTop, 1, wxEXPAND, 5);
	...
	FlexGridSizer2->Add(txtCurrentFloor, 1, wxEXPAND, 5);
	...
	FlexGridSizer2->Add(txtLastMesh, 1, wxEXPAND, 5);
	...
	FlexGridSizer2->Add(txtDesiredVel, 1, wxEXPAND, 5);
	...
	FlexGridSizer2->Add(txtVelocity, 1, wxEXPAND, 5);
	...
	FlexGridSizer2->Add(txtDesiredAngle, 1, wxEXPAND, 5);
	...
	FlexGridSizer2->Add(txtAngle, 1, wxEXPAND, 5);
	...
	FlexGridSizer2->Add(txtSpeed, 1, wxEXPAND, 5);
	...
	FlexGridSizer2->Add(txtMouseDown, 1, wxEXPAND, 5);
	...
	FlexGridSizer2->Add(txtStartFloor, 1, wxEXPAND, 5);
	...
	FlexGridSizer2->Add(txtStartPosition, 1, wxEXPAND, 5);
	...
	FlexGridSizer2->Add(txtFOV, 1, wxEXPAND, 5);
	...
	FlexGridSizer3->Add(txtGravity, 1, wxEXPAND, 5);
	...
	FlexGridSizer3->Add(txtGravityEnabled, 1, wxEXPAND, 5);
	...
	FlexGridSizer3->Add(txtCollisions, 1, wxEXPAND, 5);
	...
	FlexGridSizer3->Add(txtReportCollisions, 1, wxEXPAND, 5);
	...
	FlexGridSizer3->Add(txtFreelook, 1, wxEXPAND, 5);
	...
	FlexGridSizer3->Add(txtFreelookSpeed, 1, wxEXPAND, 5);
	...
	FlexGridSizer3->Add(txtBinocularsFOV, 1, wxEXPAND, 5);
	...
	FlexGridSizer3->Add(txtGotoFloor, 1, wxEXPAND, 5);
...
void CameraControl::Loop()
{
	...
	txtCurrentFloor->SetValue(wxString(ToString(Simcore->camera->CurrentFloor)) + wxT(" (") + Simcore->camera->CurrentFloorID + wxT(")"));
