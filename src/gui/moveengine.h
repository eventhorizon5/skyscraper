...
class MoveEngine: public wxDialog
{
	public:

		MoveEngine(DebugPanel* root, wxWindow* parent,wxWindowID id = -1, EngineContext *engine = 0);
		virtual ~MoveEngine();

		//(*Identifiers(MoveEngine)
