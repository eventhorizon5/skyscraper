...
FloorInfo::FloorInfo(DebugPanel* parent,wxWindowID id)
{
    ...
    lstFloors = new wxListBox(this, ID_lstFloors, wxDefaultPosition, wxSize(200,300), 0, 0, 0, wxDefaultValidator, _T("ID_lstFloors"));
    ...
    txtNumber = new wxTextCtrl(this, ID_txtNumber, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_txtNumber"));
    ...
    txtID = new wxTextCtrl(this, ID_txtID, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_txtID"));
    ...
    txtNumberID = new wxTextCtrl(this, ID_txtNumberID, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_txtNumberID"));
    ...
    txtFloorType = new wxTextCtrl(this, ID_txtFloorType, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_txtFloorType"));
    ...
    txtDescription = new wxTextCtrl(this, ID_txtDescription, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_txtDescription"));
    ...
    txtAltitude = new wxTextCtrl(this, ID_txtAltitude, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_txtAltitude"));
    ...
    txtHeight = new wxTextCtrl(this, ID_txtHeight, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_txtHeight"));
    ...
    txtIntHeight = new wxTextCtrl(this, ID_txtIntHeight, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_txtIntHeight"));
