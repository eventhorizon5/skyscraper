...
FloorInfo::FloorInfo(DebugPanel* parent,wxWindowID id)
{
    ...
    txtNumber = new wxTextCtrl(this, ID_txtNumber, wxEmptyString, wxDefaultPosition, wxSize(150,-1), 0, wxDefaultValidator, _T("ID_txtNumber"));
    ...
    txtName = new wxTextCtrl(this, ID_txtName, wxEmptyString, wxDefaultPosition, wxSize(150,-1), 0, wxDefaultValidator, _T("ID_txtName"));
    ...
    txtID = new wxTextCtrl(this, ID_txtID, wxEmptyString, wxDefaultPosition, wxSize(150,-1), 0, wxDefaultValidator, _T("ID_txtID"));
    ...
    txtNumberID = new wxTextCtrl(this, ID_txtNumberID, wxEmptyString, wxDefaultPosition, wxSize(150,-1), 0, wxDefaultValidator, _T("ID_txtNumberID"));
    ...
    txtFloorType = new wxTextCtrl(this, ID_txtFloorType, wxEmptyString, wxDefaultPosition, wxSize(150,-1), 0, wxDefaultValidator, _T("ID_txtFloorType"));
    ...
    txtDescription = new wxTextCtrl(this, ID_txtDescription, wxEmptyString, wxDefaultPosition, wxSize(150,-1), 0, wxDefaultValidator, _T("ID_txtDescription"));
    ...
    txtAltitude = new wxTextCtrl(this, ID_txtAltitude, wxEmptyString, wxDefaultPosition, wxSize(150,-1), 0, wxDefaultValidator, _T("ID_txtAltitude"));
    ...
    txtHeight = new wxTextCtrl(this, ID_txtHeight, wxEmptyString, wxDefaultPosition, wxSize(150,-1), 0, wxDefaultValidator, _T("ID_txtHeight"));
