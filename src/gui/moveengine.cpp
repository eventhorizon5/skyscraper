/*
	Skyscraper 2.1 - Move Engine Window
...
//(*IdInit(MoveEngine)
const long MoveEngine::ID_STATICTEXT1 = wxNewId();
const long MoveEngine::ID_lblPosition = wxNewId();
const long MoveEngine::ID_STATICTEXT3 = wxNewId();
const long MoveEngine::ID_STATICTEXT4 = wxNewId();
const long MoveEngine::ID_STATICTEXT2 = wxNewId();
const long MoveEngine::ID_lblRotation = wxNewId();
const long MoveEngine::ID_STATICLINE2 = wxNewId();
const long MoveEngine::ID_rPosition = wxNewId();
const long MoveEngine::ID_rRotation = wxNewId();
const long MoveEngine::ID_STATICTEXT28 = wxNewId();
const long MoveEngine::ID_txtMoveSpeed = wxNewId();
const long MoveEngine::ID_chkRelative = wxNewId();
const long MoveEngine::ID_bZPlus = wxNewId();
const long MoveEngine::ID_bYPlus = wxNewId();
const long MoveEngine::ID_bXNeg = wxNewId();
const long MoveEngine::ID_chkHold = wxNewId();
const long MoveEngine::ID_bXPlus = wxNewId();
const long MoveEngine::ID_bZNeg = wxNewId();
const long MoveEngine::ID_bYNeg = wxNewId();
const long MoveEngine::ID_STATICTEXT16 = wxNewId();
const long MoveEngine::ID_STATICTEXT21 = wxNewId();
const long MoveEngine::ID_txtPositionX = wxNewId();
const long MoveEngine::ID_bPositionX = wxNewId();
const long MoveEngine::ID_STATICTEXT22 = wxNewId();
const long MoveEngine::ID_txtPositionY = wxNewId();
const long MoveEngine::ID_bPositionY = wxNewId();
const long MoveEngine::ID_STATICTEXT23 = wxNewId();
const long MoveEngine::ID_txtPositionZ = wxNewId();
const long MoveEngine::ID_bPositionZ = wxNewId();
const long MoveEngine::ID_STATICLINE1 = wxNewId();
const long MoveEngine::ID_STATICTEXT27 = wxNewId();
const long MoveEngine::ID_STATICTEXT24 = wxNewId();
const long MoveEngine::ID_txtRotationX = wxNewId();
const long MoveEngine::ID_bRotationX = wxNewId();
const long MoveEngine::ID_STATICTEXT25 = wxNewId();
const long MoveEngine::ID_txtRotationY = wxNewId();
const long MoveEngine::ID_bRotationY = wxNewId();
const long MoveEngine::ID_STATICTEXT26 = wxNewId();
const long MoveEngine::ID_txtRotationZ = wxNewId();
const long MoveEngine::ID_bRotationZ = wxNewId();
const long MoveEngine::ID_STATICLINE3 = wxNewId();
//*)

BEGIN_EVENT_TABLE(MoveEngine,wxDialog)
//(*EventTable(MoveEngine)
//*)
END_EVENT_TABLE()

MoveEngine::MoveEngine(DebugPanel* root, wxWindow* parent,wxWindowID id, EngineContext *engine)
{
	//(*Initialize(MoveEngine)
	...
	Create(parent, wxID_ANY, _("Move Engine"), wxDefaultPosition, wxDefaultSize, wxCAPTION|wxSYSTEM_MENU|wxCLOSE_BOX|wxMINIMIZE_BOX, _T("wxID_ANY"));
	...
	Connect(ID_rPosition,wxEVT_COMMAND_RADIOBUTTON_SELECTED,(wxObjectEventFunction)&MoveEngine::On_rPosition_Select);
	Connect(ID_rRotation,wxEVT_COMMAND_RADIOBUTTON_SELECTED,(wxObjectEventFunction)&MoveEngine::On_rRotation_Select);
	Connect(ID_bZPlus,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&MoveEngine::On_bZPlus_Click);
	Connect(ID_bYPlus,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&MoveEngine::On_bYPlus_Click);
	Connect(ID_bXNeg,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&MoveEngine::On_bXNeg_Click);
	Connect(ID_chkHold,wxEVT_COMMAND_CHECKBOX_CLICKED,(wxObjectEventFunction)&MoveEngine::On_chkHold_Click);
	Connect(ID_bXPlus,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&MoveEngine::On_bXPlus_Click);
	Connect(ID_bZNeg,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&MoveEngine::On_bZNeg_Click);
	Connect(ID_bYNeg,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&MoveEngine::On_bYNeg_Click);
	Connect(ID_bPositionX,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&MoveEngine::On_bPositionX_Click);
	Connect(ID_bPositionY,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&MoveEngine::On_bPositionY_Click);
	Connect(ID_bPositionZ,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&MoveEngine::On_bPositionZ_Click);
	Connect(ID_bRotationX,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&MoveEngine::On_bRotationX_Click);
	Connect(ID_bRotationY,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&MoveEngine::On_bRotationY_Click);
	Connect(ID_bRotationZ,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&MoveEngine::On_bRotationZ_Click);
	//*)
	this->engine = engine;
	panel = root;
	OnInit();
...
void MoveEngine::On_rPosition_Select(wxCommandEvent& event)
{

}

void MoveEngine::On_rRotation_Select(wxCommandEvent& event)
{

}

void MoveEngine::On_bZPlus_Click(wxCommandEvent& event)
{
	if (!engine)
		return;
...
{
	Vector3 pos = Vector3(atof(txtPositionX->GetValue()), 0.0, 0.0);
	if (engine)
		engine->Move(pos, 1.0, true);
}

void MoveEngine::On_bPositionY_Click(wxCommandEvent& event)
{
	Vector3 pos = Vector3(0.0, atof(txtPositionY->GetValue()), 0.0);
	if (engine)
		engine->Move(pos, 1.0, true);
}

void MoveEngine::On_bPositionZ_Click(wxCommandEvent& event)
{
	Vector3 pos = Vector3(0.0, 0.0, atof(txtPositionZ->GetValue()));
	if (engine)
		engine->Move(pos, 1.0, true);
}
