...
public:
	...
	int AddFloorMain(WallObject* wallobject, const char *name, const char *texture, float thickness, float x1, float z1, float x2, float z2, float altitude1, float altitude2, bool direction, float tw, float th, bool autosize, bool legacy_behavior = false);
	int AddFloorMain(Object *parent, MeshObject* mesh, const char *name, const char *texture, float thickness, float x1, float z1, float x2, float z2, float altitude1, float altitude2, bool direction, float tw, float th, bool autosize, bool legacy_behavior = false);
	...
	WallObject* AddFloor(const char *meshname, const char *name, const char *texture, float thickness, float x1, float z1, float x2, float z2, float altitude1, float altitude2, bool direction, float tw, float th, bool legacy_behavior = false);
