...
public:
	...
	~GeometryController();
	Ogre::MeshPtr CreatePlane(Object* parent, const std::string& name, unsigned int segments_x, unsigned int segments_y, Real size_x, Real size_y, Real utile, Real vtile);
