...
public:
	...
	Ogre::MeshPtr CreateCylinder(Real height, Real radius, Real utile, Real vtile, unsigned int segments_base, unsigned int segments_height, bool capped, const std::string& name);
