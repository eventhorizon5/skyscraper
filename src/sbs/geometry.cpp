...
{
	return Procedural::SphereGenerator().setScale(1.0 / sbs->UnitScale).setRadius(radius).setUTile(utile).setVTile(vtile).setNumRings(rings).setNumSegments(segments).realizeMesh(parent->GetNameBase() + name);
}
...
{
	return Procedural::CylinderGenerator().setScale(1.0 / sbs->UnitScale).setHeight(height).setRadius(radius).setUTile(utile).setVTile(vtile).setNumSegBase(segments_base).setNumSegHeight(segments_height).setCapped(capped).realizeMesh(parent->GetNameBase() + name);
}
...
{
	return Procedural::TorusGenerator().setScale(1.0 / sbs->UnitScale).setRadius(radius).setSectionRadius(section_radius).setUTile(utile).setVTile(vtile).realizeMesh(parent->GetNameBase() + name);
}
...
{
	return Procedural::ConeGenerator().setScale(1.0 / sbs->UnitScale).setRadius(radius).setHeight(height).setNumSegBase(segments_base).setNumSegHeight(segments_height).setUTile(utile).setVTile(vtile).realizeMesh(parent->GetNameBase() + name);
}
...
{
	return Procedural::TubeGenerator().setScale(1.0 / sbs->UnitScale).setHeight(height).setUTile(utile).setVTile(vtile).setNumSegBase(segments_base).setNumSegHeight(segments_height).setInnerRadius(inner_radius).setOuterRadius(outer_radius).realizeMesh(parent->GetNameBase() + name);
}
...
{
	return Procedural::BoxGenerator().setScale(1.0 / sbs->UnitScale).setSizeX(size_x).setSizeY(size_y).setSizeZ(size_z).setNumSegX(segments_x).setNumSegY(segments_y).setNumSegZ(segments_z).setUTile(utile).setVTile(vtile).realizeMesh(parent->GetNameBase() + name);
}
...
{
	return Procedural::CapsuleGenerator().setScale(1.0 / sbs->UnitScale).setRadius(radius).setHeight(height).setNumRings(rings).setNumSegHeight(segments_height).setNumSegments(segments).setUTile(utile).setVTile(vtile).realizeMesh(parent->GetNameBase() + name);
}
...
{
	return Procedural::TorusKnotGenerator().setScale(1.0 / sbs->UnitScale).setRadius(radius).setSectionRadius(section_radius).setUTile(utile).setVTile(vtile).setNumSegCircle(segments_circle).setNumSegSection(seg_section).setP(p).setQ(q).realizeMesh(parent->GetNameBase() + name);
}
...
{
	return Procedural::IcoSphereGenerator().setScale(1.0 / sbs->UnitScale).setRadius(radius).setNumIterations(iterations).setUTile(utile).setVTile(vtile).realizeMesh(parent->GetNameBase() + name);
}
...
{
	return Procedural::RoundedBoxGenerator().setScale(1.0 / sbs->UnitScale).setSizeX(size_x).setSizeY(size_y).setSizeZ(size_z).setChamferSize(chamfer_size).setNumSegX(segments_x).setNumSegY(segments_y).setNumSegZ(segments_z).setUTile(utile).setVTile(vtile).realizeMesh(parent->GetNameBase() + name);
}
