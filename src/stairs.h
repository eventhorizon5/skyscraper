...
public:
	...
	csArray<WallObject*> stairs_walls;
	...
	Object* AddDoor(int floor, const char *texture, float thickness, int direction, float CenterX, float CenterZ, float width, float height, float voffset, float tw, float th);
