...
SoundManager::SoundManager(DebugPanel* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	tName = new wxTextCtrl(this, ID_tName, wxEmptyString, wxDefaultPosition, wxSize(150,-1), wxTE_READONLY, wxDefaultValidator, _T("ID_tName"));
	...
	tPlaying = new wxTextCtrl(this, ID_tPlaying, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY, wxDefaultValidator, _T("ID_tPlaying"));
	...
	tPosition = new wxTextCtrl(this, ID_tPosition, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY, wxDefaultValidator, _T("ID_tPosition"));
	...
	tVolume = new wxTextCtrl(this, ID_tVolume, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_tVolume"));
	FlexGridSizer4->Add(tVolume, 1, wxEXPAND, 5);
	bSetVolume = new wxButton(this, ID_bSetVolume, _("Set"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_bSetVolume"));
	...
	tLoop = new wxTextCtrl(this, ID_tLoop, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_tLoop"));
	FlexGridSizer4->Add(tLoop, 1, wxEXPAND, 5);
	bSetLoop = new wxButton(this, ID_bSetLoop, _("Set"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_bSetLoop"));
	...
	tPaused = new wxTextCtrl(this, ID_tPaused, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_tPaused"));
	FlexGridSizer4->Add(tPaused, 1, wxEXPAND, 5);
	bSetPause = new wxButton(this, ID_bSetPause, _("Set"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_bSetPause"));
	...
	tSpeed = new wxTextCtrl(this, ID_tSpeed, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_tSpeed"));
	FlexGridSizer4->Add(tSpeed, 1, wxEXPAND, 5);
	bSetSpeed = new wxButton(this, ID_bSetSpeed, _("Set"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_bSetSpeed"));
	...
	tPlayPosition = new wxTextCtrl(this, ID_tPlayPosition, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxTE_READONLY, wxDefaultValidator, _T("ID_tPlayPosition"));
