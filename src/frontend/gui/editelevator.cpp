/*
	Skyscraper 2.0 Alpha - Edit Elevator Form
...
editelevator::editelevator(DebugPanel* parent,wxWindowID id)
{
	...
	FlexGridSizer1->Add(bSetID, 1, wxLEFT|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 5);
...
void editelevator::On_bFan_Click(wxCommandEvent& event)
{
	if (car)
		car->Fan = !car->Fan;
}
...
void editelevator::On_bSelectCurrent_Click(wxCommandEvent& event)
{
	...
	if (Simcore->InElevator == true && Simcore->camera && car)
	{
