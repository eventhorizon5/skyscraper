/*
	Skyscraper 1.12 Alpha - Object Creation Dialog
...
CreateObject::CreateObject(DebugPanel *root, wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	StaticBoxSizer1->Add(bLoadTexture, 1, wxALL|wxALIGN_TOP, 5);
	...
	GridSizer1->Add(bAddInterfloorFloor, 1, wxALL|wxEXPAND, 5);
	...
	GridSizer1->Add(bAddInterfloorWall, 1, wxALL|wxEXPAND, 5);
	...
	GridSizer1->Add(bAddShaftFloor, 1, wxALL|wxEXPAND, 5);
	...
	GridSizer1->Add(bAddShaftWall, 1, wxALL|wxEXPAND, 5);
	...
	GridSizer1->Add(bAddStairsFloor, 1, wxALL|wxEXPAND, 5);
	...
	GridSizer1->Add(bAddStairsWall, 1, wxALL|wxEXPAND, 5);
	...
	GridSizer1->Add(bColumnWallBox, 1, wxALL|wxEXPAND, 5);
	...
	GridSizer1->Add(bColumnWallBox2, 1, wxALL|wxEXPAND, 5);
	...
	GridSizer1->Add(bCreateCallButtons, 1, wxALL|wxEXPAND, 5);
	...
	GridSizer1->Add(bAddStairsDoor, 1, wxALL|wxEXPAND, 5);
	...
	GridSizer1->Add(bAddDirectionalIndicator, 1, wxALL|wxEXPAND, 5);
	...
	GridSizer1->Add(bAddShaftDoor, 1, wxALL|wxEXPAND, 5);
	...
	GridSizer1->Add(bFloorCutAll, 1, wxALL|wxEXPAND, 5);
	...
	GridSizer1->Add(bAddFillerWalls, 1, wxALL|wxEXPAND, 5);
	...
	GridSizer1->Add(bFloorAddSound, 1, wxALL|wxEXPAND, 5);
	...
	GridSizer1->Add(bShaftDoorComponent, 1, wxALL|wxEXPAND, 5);
	...
	GridSizer1->Add(bFinishShaftDoor, 1, wxALL|wxEXPAND, 5);
	...
	GridSizer1->Add(bFloorAddModel, 1, wxALL|wxEXPAND, 5);
	...
	GridSizer1->Add(bAddStairsModel, 1, wxALL|wxEXPAND, 5);
	...
	GridSizer1->Add(bAddShaftModel, 1, wxALL|wxEXPAND, 5);
	...
	GridSizer1->Add(bAddShaftStdDoor, 1, wxALL|wxEXPAND, 5);
	StaticBoxSizer2->Add(GridSizer1, 1, wxALL|wxALIGN_LEFT, 5);
	...
	bElevator->Disable();
	StaticBoxSizer3->Add(bElevator, 1, wxALL|wxALIGN_TOP, 5);
	...
	bShaft->Disable();
	StaticBoxSizer4->Add(bShaft, 1, wxALL|wxALIGN_TOP, 5);
