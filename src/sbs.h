...
public:
	...
	int AddCustomWall(WallObject* wallobject, const char *name, const char *texture, Ogre::Polygon &varray, float tw, float th);
	void InitMeshes();
	...
	void GetTextureMapping(Ogre::Polygon &vertices, Ogre::Vector3 &v1, Ogre::Vector3 &v2, Ogre::Vector3 &v3);
