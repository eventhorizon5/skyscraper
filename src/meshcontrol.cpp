...
MeshControl::MeshControl(wxWindow* parent,wxWindowID id)
{
	...
	StaticText2 = new wxStaticText(this,ID_STATICTEXT2,_("Per-Floor Meshes"),wxPoint(138,7),wxDefaultSize,0,_("ID_STATICTEXT2"));
	chkColumnFrame = new wxCheckBox(this,ID_chkColumnFrame,_("Column Frame"),wxPoint(7,99),wxDefaultSize,0,wxDefaultValidator,_("ID_chkColumnFrame"));
	chkColumnFrame->SetValue(false);
	chkSky = new wxCheckBox(this,ID_chkSky,_("Sky"),wxPoint(7,80),wxDefaultSize,0,wxDefaultValidator,_("ID_chkSky"));
	chkSky->SetValue(false);
	chkLandscape = new wxCheckBox(this,ID_chkLandscape,_("Landscape"),wxPoint(7,62),wxDefaultSize,0,wxDefaultValidator,_("ID_chkLandscape"));
	chkLandscape->SetValue(false);
	chkBuildings = new wxCheckBox(this,ID_chkBuildings,_("Buildings"),wxPoint(7,45),wxDefaultSize,0,wxDefaultValidator,_("ID_chkBuildings"));
	chkBuildings->SetValue(false);
	chkExternal = new wxCheckBox(this,ID_chkExternal,_("External"),wxPoint(7,26),wxDefaultSize,0,wxDefaultValidator,_("ID_chkExternal"));
	chkExternal->SetValue(false);
	StaticText1 = new wxStaticText(this,ID_STATICTEXT1,_("Primary Meshes"),wxPoint(7,8),wxSize(83,13),0,_("ID_STATICTEXT1"));
	//*)
	p = this;
	OnInit();
}
