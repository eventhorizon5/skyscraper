...
public:
	...
	int AddWall(const char *name, const char *texture, double thickness, double x1, double z1, double x2, double z2, double height1, double height2, double voffset1, double voffset2, double tw, double th, double tw_s, double th_s, bool revX, bool revY, bool revZ);
	int AddFloor(const char *name, const char *texture, double thickness, double x1, double z1, double x2, double z2, double voffset1, double voffset2, double tw, double th, double tw_s, double th_s);
	int AddFloorIndicator(const char *direction, double CenterX, double CenterZ, double width, double height, double voffset);
	int AddDoors(const char *texture, double thickness, double CenterX, double CenterZ, double width, double height, bool direction, double tw, double th, double tw_s, double th_s);
	int AddShaftDoors(const char *texture, double thickness, double CenterX, double CenterZ, double tw, double th, double tw_s, double th_s);
