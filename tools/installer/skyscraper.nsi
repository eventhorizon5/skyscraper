...
OutFile "skyscraper20alpha10.exe"
...
Section "Required libraries" SEC03
  ...
  File "${LOCAL_FILES}\wxbase30u_vc_custom.dll"
  File "${LOCAL_FILES}\wxmsw30u_core_vc_custom.dll"
  File "${LOCAL_FILES}\wxmsw30u_gl_vc_custom.dll"
  ...
  File "${LOCAL_FILES}\vc_redist.x86.exe"
  ExecWait '"$INSTDIR\vc_redist.x86.exe" /Q'
  Delete "${LOCAL_FILES}\vc_redist.x86.exe"
