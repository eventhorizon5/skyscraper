...
'Skycraper 0.97 Beta - Main initialization code
...
Global FloorHeightTable(-10 To 138, 0 To 1) As Single
Global FloorNameTable(-10 To 138) As String
...
Sim.Label1.Caption = Sim.Label1.Caption + "Compiled on May 11, 2004" + vbCrLf + vbCrLf
